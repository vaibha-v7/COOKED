    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#0b0324] [background:radial-gradient(circle_at_20%_20%,rgba(111,66,193,0.28),transparent_32%),_radial-gradient(circle_at_80%_10%,rgba(18,144,255,0.22),transparent_32%),_radial-gradient(circle_at_50%_90%,rgba(255,124,0,0.18),transparent_38%),_linear-gradient(160deg,#0b0324_0%,#0c0a1a_55%,#0c0a1a_100%)] px-4 py-8 font-['Space_Grotesk']">
            <div className="w-full max-w-3xl">
                ...
                {roast && (
                    <p className="mb-6 text-center text-base font-['Press_Start_2P'] text-[#ff8c32] leading-tight [text-shadow:3px_3px_0_rgba(0,0,0,0.6),0_0_25px_rgba(255,140,50,0.4)] uppercase tracking-wider px-2">
                        {roast}
                    </p>
                )}
                            ...
                            <div key={idx} className="flex items-center gap-4">
                                ...
                                {artist.image && (
                                    <img
                                        src={artist.image}
                                        alt={artist.name}
                                        className="h-16 w-16 flex-shrink-0 rounded-lg object-cover border border-white/10"
                                    />
                                )}
                                <div className="flex-1 min-w-0">
                                    <h3 className="font-bold text-[#e7e9ff] truncate">{artist.name}</h3>
                                    {/* <p className="text-sm text-[#c5c8e8]">
